...
# 1️⃣ Awesome Agentic Based Papers

> ✏️ Here we collects long video understanding methods that use agents and categorizes them into two groups: training-free methods and training-based methods.
>
> ⚠️ All included papers provide open-source code, and works with empty code repositories have been excluded.
>
> [这里整理所有使用智能体（Agent）的长视频理解（Long Video Understanding）方法。并分为免训练（Training-Free）和训练（Training）两类方法。所有论文均选取有开源代码的工作，并且已排除代码仓库为空的情况。]
...
# 2️⃣ Awesome Non-Agentic Papers

> ✏️  Here we collects non-agentic based long video understanding methods.
>
> ⚠️  All included papers provide open-source code, and works with empty code repositories have been excluded.
>
> [ 这里整理所有使用非智能体（Non-Agentic）的长视频理解（Long Video Understanding）方法。所有论文均选取有开源代码的工作，并且已排除代码仓库为空的情况。]
...
# 3️⃣ Awesome Benchmarks

## ⚙️ Eval Benchmarks

| ⏰ Year |   📊Benchmark    | ✨ Full Name                                                  |   🏅Source    |
| :----: | :-------------: | :----------------------------------------------------------- | :----------: |
|  2026  |  Video-MME-v2   | Video-MME-v2: Towards the Next Stage in Benchmarks for Comprehensive Video Understanding. <br/> <a href="https://arxiv.org/abs/2604.05015"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2604.05015-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://video-mme-v2.netlify.app/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |      -       |
|  2026  | VideoSIAH-Eval  | LongVT paper curated benchmark for long-video temporal reasoning and tool-calling evaluation.  <br/><a href="https://arxiv.org/abs/2511.20785"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2511.20785-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://github.com/EvolvingLMMs-Lab/LongVT"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Code-181717?logo=github&logoColor=white"></a> |  CVPR 2026   |
|  2026  | Video-CoM-Bench | Video-CoM: Interactive Video Reasoning via Chain of Manipulations.  <br/><a href="https://arxiv.org/abs/2511.23477"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2511.23477-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://github.com/mbzuai-oryx/Video-CoM"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |  CVPR 2026   |
|  2025  | MMVU / MMVU-Val | A benchmark for evaluating multimodal video understanding and reasoning.  <br/><a href="https://arxiv.org/abs/2511.07250"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2511.07250-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://mmvu-benchmark.github.io/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |      -       |
|  2025  |     MINERVA     | MINERVA: Evaluating Complex Video Reasoning.  <br/><a href="https://arxiv.org/abs/2505.00681"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2505.00681-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://github.com/google-deepmind/neptune?tab=readme-ov-file"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Code-181717?logo=github&logoColor=white"></a> |  ICCV 2025   |
|  2025  |      MLVU       | A Comprehensive Benchmark for Multi-Task Long Video Understanding.  <br/><a href="https://arxiv.org/abs/2406.04264"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2406.04264-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://github.com/JUNJIE99/MLVU"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Code-181717?logo=github&logoColor=white"></a> |  CVPR 2025   |
|  2025  |     LVBench     | An Extreme Long Video Understanding Benchmark. <br/> <a href="https://arxiv.org/abs/2406.08035"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2406.08035-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://lvbench.github.io/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |  ICCV 2025   |
|  2025  |    Video-MME    | The First-Ever Comprehensive Evaluation Benchmark of Multi-modal LLMs in Video Analysis. <br/> <a href="https://arxiv.org/pdf/2405.21075"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2405.21075-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://video-mme.github.io/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |  CVPR 2025   |
|  2024  |    EgoSchema    | A diagnostic benchmark for very long-form video language understanding.  <br/><a href="https://arxiv.org/abs/2308.09126"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2308.09126-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://egoschema.github.io/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |      -       |
|  2024  |     WorldQA     | WorldQA: Multimodal World Knowledge in Videos through Long-Chain Reasoning.  <br/><a href="https://arxiv.org/abs/2405.03272"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2405.03272-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://zhangyuanhan-ai.github.io/WorldQA/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |      -       |
|  2024  | LongVideoBench  | LongVideoBench: A Benchmark for Long-context Interleaved Video-Language Understanding. <br/> <a href="https://arxiv.org/abs/2407.15754"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2407.15754-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://longvideobench.github.io/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> | NeurIPS 2024 |
|  2024  |  MovieChat-1K   | From Dense Token to Sparse Memory in Long Video Understanding.  <br/><a href="https://arxiv.org/abs/2307.16449v2"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2307.16449v2-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://wenhaochai.com/MovieChat/"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Page-181717?logo=github&logoColor=white"></a> |  CVPR 2024   |
|  2024  |     NExT-QA     | A benchmark for evaluating multimodal video understanding and reasoning.  <br/><a href="https://arxiv.org/abs/2105.08276"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2105.08276-b31b1b?logo=arxiv&logoColor=white"></a><a href="https://github.com/doc-doc/NExT-QA"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Code-181717?logo=github&logoColor=white"></a> |  CVPR 2021   |
